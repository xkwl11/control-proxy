...
router.post('/approve/:id', (req,res) => {
  ...
  db.prepare('INSERT INTO audit_logs (action,detail,actor,ts) VALUES (?,?,?,?)').run('approve', JSON.stringify(app), 'local_admin', nowSec());
...
router.post('/reject/:id', (req,res) => {
  ...
  db.prepare('INSERT INTO audit_logs (action,detail,actor,ts) VALUES (?,?,?,?)').run('reject', JSON.stringify(app), 'local_admin', nowSec());
